...
import { PAGE_NOT_FOUND_ROUTE, REDIRECT_ROUTE } from '@/routers/routes/basic'
import { getRawRoute } from '@/utils'
import { MULTIPLE_TABS_KEY } from '@/enums/cache-enum'
  ...
  actions: {
    ...
    async addTab(route: RouteLocationNormalized) {
      ...
      if (tabHasExits) {
        ...
        const dynamicLevel = meta?.dynamicLevel ?? 5
