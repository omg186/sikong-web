  ...
  <div>
    ...
    >
      ...
      <div class="h-full flex justify-end items-center gap-x-10px text-xs">
        ...
        <span class="flex items-center gap-5px">
          <i
            class="w-16px h-16px flex justify-center items-center bg-[#FFD13C] rounded-6px"
            s:border="1px solid [#FFD13C]"
          >
          </i>
          已选测评
        </span>
    ...
    >
      <div>
        ...
        >
          ...
          <div class="flex time-item-confirm">
            <TimeItemVue
              :times="time"
              :isEdit="false"
    ...
    <div class="flex flex-col gap-y-10px">
      ...
      ></TextItem>
      <TextItem title="审核人意见" contents="同意"></TextItem>
      <TextItem
        title="审核人说明"
        contents="以满足客户需求为主，同意新开待办测评意"
      ></TextItem>
    </div>
