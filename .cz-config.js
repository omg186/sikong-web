module.exports = {
  types: [
    ...
    {
      value: 'refactor',
      name: 'refactor: 代码重构(既不修复bug也不添加特性的代码更改)',
    },
    { value: 'perf', name: 'perf: 代码重构(改进性能的代码更改)' },
    { value: 'test', name: 'test: 添加缺失的测试或修改现有的测试' },
    {
      value: 'build',
      name: 'build: 影响构建系统或外部依赖项的更改(例如作用域:gulp、broccoli、npm)',
    },
    {
      value: 'ci',
      name: 'ci: 对CI配置文件和脚本的更改(示例范围:Travis、Circle、BrowserStack、SauceLabs)',
    },
